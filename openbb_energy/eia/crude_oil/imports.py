...
class CrudeOilImportsQueryParams(QueryParams):
    ...
    filter_by_origin_id: Optional[OriginIdType] = Field(
        ...
        default=None,
        alias="originId",
        json_schema_extra={"choices": ORIGIN_IDS},
    )

    filter_by_origin_type: Optional[OriginIdType] = Field(
    ...
    filter_by_destination_id: Optional[DestinationIdType] = Field(
        ...
        default=None,
        alias="destinationId",
        json_schema_extra={"choices": DESTINATION_IDS},
    )

    filter_by_destination_type: Optional[DestinationIdType] = Field(
    ...
    filter_by_grade_id: Optional[GradeIdType] = Field(
        ...
        default=None,
        alias="gradeId",
        json_schema_extra={"choices": GRADE_IDS},
    )
...
class CrudeOilImportsData(Data):
    ...
    origin_name: Optional[str] = Field(
        description="Origin Name", alias="originName", default=None
    )
    ...
    origin_type_name: Optional[str] = Field(
        description="Origin Type Name", alias="originTypeName", default=None
    )
    ...
    destination_name: Optional[str] = Field(
        description="Destination Name", alias="destinationName", default=None
    )
    ...
    destination_type_name: Optional[str] = Field(
        description="Destination Type Name", alias="destinationTypeName", default=None
    )
    grade_id: Optional[str] = Field(
        description="Grade ID", alias="gradeId", default=None
    )
    grade_name: Optional[str] = Field(
        description="Grade Name", alias="gradeName", default=None
    )
    value: float = Field(
        description="Import volume in thousand barrels", alias="quantity"
    )
    units: Optional[str] = Field(
        description="Units of measurement",
        default="thousand barrels",
        alias="quantity-units",
    )
    ...
    def extract_data(  # pylint: disable=unused-argument
        ...
        **kwargs: Any,
        ...
        params = make_eia_params(
            query=query, facet_list=CRUDE_OIL_FACET_LIST, data_param="quantity"
        )
