...
CRUDE_OIL_FACET_LIST = ["originId", "originType", "destinationId", "destinationType", "gradeId"]
...
class CrudeOilImportsData(Data):
    ...
    origin_id: Optional[str] = Field(description="Origin ID", alias="originId", default=None)
    origin_name: Optional[str] = Field(description="Origin Name", alias="origin-name", default=None)
    origin_type_id: Optional[str] = Field(description="Origin Type ID", alias="originType", default=None)
    origin_type_name: Optional[str] = Field(description="Origin Type Name", alias="originType-name", default=None)
    destination_id: Optional[str] = Field(description="Destination ID", alias="destinationId", default=None)
    destination_name: Optional[str] = Field(description="Destination Name", alias="destination-name", default=None)
    destination_type_id: Optional[str] = Field(description="Destination Type ID", alias="destinationType", default=None)
    destination_type_name: Optional[str] = Field(description="Destination Type Name", alias="destinationType-name", default=None)
    grade_id: Optional[str] = Field(description="Grade ID", alias="gradeId", default=None)
    grade_name: Optional[str] = Field(description="Grade Name", alias="grade-name", default=None)
    value: Optional[float] = Field(description="Import volume in thousand barrels")
    units: Optional[str] = Field(description="Units of measurement", default="thousand barrels")
...
class CrudeOilImportsFetcher(Fetcher[CrudeOilImportsQueryParams, List[CrudeOilImportsData]]):
